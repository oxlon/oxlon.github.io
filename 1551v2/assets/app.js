...
async function viewOverview(params, ticket) {
  ...
  for (const c of filtered) {
    ...
    html+='<tr class="indicator-row"><th colspan="'+(years.length+3)+'">'+escapeHTML(c.label)+' <a class="indicator-audit-link" href="#/differences?indicator='+encodeURIComponent(c.concept_id)+'&year='+(start<=2025&&end>=2025?2025:start)+'">'+(lang==='az'?'Təriflər və metodlar':'Definitions and methods')+' →</a></th></tr>';
    for(const m of maps){
...
async function viewDifferences(params,ticket) {
 ...
 h+='<nav class="section-jumps" aria-label="Method sections"><a href="#ownership">Providers and roles</a><a href="#all-indicator-audit">All 25 indicators</a><a href="#fr-scope">All FR1–FR12</a><a href="#cpi-case">2025 CPI explained</a><a href="#technical-methods">Technical calculations</a><a href="#fair-comparison">A consistent comparison</a></nav>';
 ...
 h+='<section class="panel" id="all-indicator-audit"></section><section class="panel" id="caem-account-check"></section>';
 ...
 if(params.has('indicator'))$('#indicator-controls').scrollIntoView({block:'start'});
